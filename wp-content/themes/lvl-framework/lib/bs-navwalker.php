...
if ( ! class_exists( 'WP_Bootstrap_Navwalker' ) ) :
	...
	class WP_Bootstrap_Navwalker extends Walker_Nav_Menu {
		...
		public function start_lvl( &$output, $depth = 0, $args = null ) {
			...
			$output .= "<button title=\"Dropdown Toggle\" class=\"mobile-toggle collapsed\" data-bs-toggle=\"collapse\" data-bs-target=\"#$uid\" aria-expanded=\"false\" aria-controls=\"$uid\"><svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 256 512\"><path fill=\"currentColor\" d=\"M24.707 38.101L4.908 57.899c-4.686 4.686-4.686 12.284 0 16.971L185.607 256 4.908 437.13c-4.686 4.686-4.686 12.284 0 16.971L24.707 473.9c4.686 4.686 12.284 4.686 16.971 0l209.414-209.414c4.686-4.686 4.686-12.284 0-16.971L41.678 38.101c-4.687-4.687-12.285-4.687-16.971 0z\"></path></svg></button>";
			
			$output .= "{$n}{$indent}<ul id=\"$uid\" $class_names $labelledby>{$n}";
		}
