...
if ($is_transparent) {
	...
	if (get_field('sitelogo_transparent', 'options')) {
		$logo_light = get_field('sitelogo_transparent', 'options');
	}
}
?>
...
<header id="header" data-bs-theme="dark" class="<?php echo implode(' ', $header_classes); ?>" <?php echo implode(" ", $header_attrs) ?>>
	<div id="navbar" class="nav-wrapper">
		<nav class="main-nav-wrapper navbar navbar-expand-lg p-lg-0 px-md-4 px-lg-5" aria-label="Main Navigation">
					...
					<div class="main-nav">
						<div class="collapse navbar-collapse" id="mainNavDropdown">
							<?php wp_nav_menu([
									...
									'container'      => '',
									'menu_class'     => 'navbar-nav ms-auto me-lg-0 mt-0 gap-lg-2 mega-menu--wrapper navbar-nav-scroll',
									'menu_id'        => 'main-menu',
									'fallback_cb'    => false,
		...
		<nav class="utility-nav navbar navbar-expand p-0 px-md-4 px-lg-5" aria-label="Utility Navigation">
			<div class="nav-container container-fluid justify-content-lg-end ms-auto">
				<div class="collapse navbar-collapse justify-content-center justify-content-lg-end" id="topNavDropdown">
